...
void main() async {
  // Убедитесь, что все плагины инициализированы
  WidgetsFlutterBinding.ensureInitialized();

  // Инициализация Supabase
  await Supabase.initialize(
    url: 'https://hvtufmrmhwcqqhlkradu.supabase.co', // Замените на ваш URL Supabase
    anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imh2dHVmbXJtaHdjcXFobGtyYWR1Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzQyNjUxMTIsImV4cCI6MjA0OTg0MTExMn0.kb-GTWVs8Alpl6GUZVs5-POYFxeIYfCgstVwmUZGmxY', // Замените на ваш Anon Key Supabase
  );
